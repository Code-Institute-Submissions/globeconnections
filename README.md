...
- [LARGE-SCREENS-WIRE-FRAMES](/assets/wireframes/large-screens-wireframe-GLOBECONNECTIONS.pdf "wireframe for large-sized screens")
...
| (ii) [PLACES AUTOCOMPLETE HOTEL SEARCH](https://developers-dot-devsite-v2-prod.appspot.com/maps/documentation/javascript/examples/places-autocomplete-hotelsearch "This example creates a map with a search box that finds all of the hotels in a specified place within a given country.") |
|   |
...
*(11) The jQuery code to open the map in a new window has been written by Eventyret Mentor from [GITHUB](https://github.com/eventyret "The world's leading software development platform").*
