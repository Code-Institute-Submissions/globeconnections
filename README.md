...
| ------------ |
| **(ii) The form throws an error (For e.g.: Please fill in this field), when any of the input fields are left blank or if an invalid email address is entered.  The site navigator will not be able to submit the form in this event.** |
